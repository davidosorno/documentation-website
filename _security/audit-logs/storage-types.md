...
or
```
plugins.security.audit.config.http_endpoints: ['https://my-opensearch-cluster.company.com:9200','my-opensearch-cluster.company.com:9200', 'https://my-opensearch-cluster.company.com:9200/opensearch']
```
